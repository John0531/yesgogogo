    ...
    <div class="container py-5">
      <div class="row justify-content-center">
        <div class="col-md-10 fs-md-5">
          ...
          <ul class="mb-5">
            <li>www.yesgogogo.com：yesgogogo 即食購購物網，提供網路購物電子商務服務</li>
          </ul>
          <h4 class="mb-3">個人資料蒐集方式</h4>
          <p class="mb-3">
            我們擁有客戶的個人資料，是由在本公司所經營的電子商務網站註冊會員、消費之客戶、使用Cookie的技術，由瀏覽器上之數值(包括IP Address、Cookies) 所取得；或是由我們在其他行銷或異業結盟活動中另行合法取得(包括但不限於自業務合作廠商處取得)。
          </p>
          ...
          <ul class="mb-5">
            ...
            <li>Ｃ○一二 身體描述。<br>例如：身高、體重</li>
            <li>Ｃ○二一 家庭情形。<br>例如：結婚有無、配偶或同居人之姓名、前配偶或同居人之姓名、結婚之日期、子女之人數等。血型等。</li>
          ...
          <p class="mb-3">
            本公司電子商務網站伺服器自動記錄顧客所閱讀的網頁、顧客所來自的網域名稱，作為內容與系統改進、廣告效果評估之依據。我們可能為進行商業及市場分析，並提供更適合客戶商品之故，在本公司或合作之其他機構間運用您同意提供的基本資料、其他資料。
          </p>
          <p class="mb-3">
          ...
          <p class="mb-5">
            關於此份隱私權聲明，我們得隨時因應社會環境及法令規定的變遷與科技的進步進行修改，並將修改內容以電子郵件、電話、型錄、通信網路、網路公告或其他適當方式通知客戶；當您使用 yesgogogo 即食購購物網所提供之任一服務時，即表示您已閱讀、瞭解並同意接受本服務條款之所有內容及其後修改變更。
          </p>
          <h4 class="mb-3">電子發票作業個資保護告知條款</h4>
          <p class="mb-3">
            客戶於 yesgogogo 即食購購物網進行消費時，開立電子發票請知悉下述聲明：
          </p>
          <ul class="list-unstyled mb-3">
            <li>
            ...
            <li>
              <div class="d-flex mb-2 ms-1">七
                <div class="ms-2">電子發票相關資訊：
                  <ul class="list-unstyled">
                    <li>會員就查詢、捐贈、兌獎及電子發票有關之資訊，可至本公司官網：https://www.yesgogogo.com「客服中心」。</li>
                  </ul>
                </div>
              </div>
            </li>

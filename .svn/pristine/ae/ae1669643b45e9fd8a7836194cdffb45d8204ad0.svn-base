...
// import JQuery from '@/assets/js/JQ.js'
// window.$ = JQuery
// JavaScript Document
/* Confetti by Patrik Svensson (http://metervara.net) */
/* eslint-disable */
...
function ConfettiRibbon(_x, _y, _count, _dist, _thickness, _angle, _mass, _drag) {
    ...
    this.ySpeed = Math.random() * 80 + 120;
...
confetti.Context = function (parent) {
    ...
    if ($(window).width() > 767) {
        var confettiPaperCount = 120; //蝣𡒊�蹱彍���(���𧋦25)
    } else {
        var confettiPaperCount = 85; //蝣𡒊�蹱彍���(���𧋦25)
    }

<template>
  <div class="bg_popup">
    <!-- 活動結束  -->
    <div v-if="idx === -1">
      <p class="popupEnd h1 text-center fw-medium py-5">本活動已結束</p>
    </div>
    <div v-else>
      <!-- PC 版 banner -->
      <div class="headerxl d-none d-lg-block text-center position-relative">
        <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/061808.jpg" alt="banner" class="img-fluid">
        <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0618banner.png" alt="" class="position-absolute headerTitle img-fluid shiny">
        <div class="events-lg position-absolute">
          ...
          >
            <swiper-slide>
              <img
                class="img-fluid"
                src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/061810.png"
                alt="狂購68元搶不買捶心肝"
              />
            </swiper-slide>
            <swiper-slide>
              <img
                class="swiper-banner2 img-fluid"
                src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/061811.png"
                alt="全站滿$1500現折$168"
              />
            </swiper-slide>
          </swiper>
      ...
      <!-- 手機版 banner -->
      <div class="header d-lg-none text-center position-relative">
        <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0618mb2.png" alt="banner_m" class="img-fluid">
        <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0618banner.png" alt="" class="position-absolute headerTitle_m img-fluid w-75 shiny">
        <div class="events-m position-absolute">
          ...
          >
            ...
            <swiper-slide>
              <img
                class="swiper-banner2-m img-fluid"
                src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/061811.png"
                alt="全站滿$1500現折$168"
              />
            </swiper-slide>
      ...
      <!-- 閃購 1  -->
      <div class="bg_03">
        <section v-if="!popupProducts && idx === 0" class="notify mb-3 mb-md-5">
          <div class="container">
            <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/commingsoon.png" alt="敬請期待 banner" class="img-fluid">
          </div>
        </section>
        <section v-else-if="!popupProducts && idx === 2" class="notify mb-3 mb-md-5">
          <div class="container">
            <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0624notify.png" alt="敬請期待 banner" class="img-fluid">
          </div>
        </section>
        <section v-else class="bg_02">
          <div class="container pb-4 pb-lg-6">
            ...
            <div class="popup_1st position-relative d-none d-lg-block">
              <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/title_02.png" alt="閃購區塊 1 上方(PC)" class="img-fluid">
              <div class="count_position_m position-absolute start-0 end-0 px-5">
                ...
                <img v-if="idx < 2" src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0618title.png" alt="閃購標題 7" class="img-fluid popupTitle_1st">
                <img v-else src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0624title.png" alt="閃購標題 8" class="img-fluid popupTitle_1st">
              </div>
            </div>
            <!-- 手機版 閃購 1 標題 -->
            <div class="popup_1st_m position-relative d-lg-none">
              <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/title_02_m.png" alt="閃購區塊 1 上方(手機)" class="img-fluid">
              <div class="count_position_m position-absolute start-0 end-0 px-3 px-md-4">
                ...
                <img v-if="idx < 2" src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0618title.png" alt="閃購標題 7" class="img-fluid">
                <img v-else src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/0624title.png" alt="閃購標題 8" class="img-fluid">
              </div>
            </div>
            ...
            <img src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/weekendpopup/title_02_bottom.png" alt="下方圓弧" class="img-fluid d-block">
          </div>
        </section>
        <!-- 看更多優惠活動 -->
        <section class="bg_01">
...
export default {
  data () {
    return {
      ...
      days: '',
      popupDate: [
        '2022/06/17 00:00:00', '2022/06/19 23:59:59',
        '2022/06/24 00:00:00', '2022/06/26 23:59:59'
      ],
      timeinterval: '',
      deadline: '',
      popupDuration: false,
...
@import '@/assets/scss/activity/weekendpopup/_site618.scss';
img{
  object-fit: fill;
}
</style>

                  ...
                  >
                    ...
                    <li class="nav-item">
                      <a
                        ...
                        @click.prevent="getRandomNum();this.myModal.show()"
                        >登入</a
                      >
                    </li>
                  </ul>
        ...
        >
          ...
          <div class="accordion mobileCategoryAccordion" id="mobileCategoryList">
            ...
            <div class="accordion-item" v-for="menu in menuList" :key="menu.id">
              <h2 class="accordion-header">
                <!-- 可以與menu比對，在button的外層他沒有加上router-link，所以在手機版的時候，點選小管路由才會變 -->
                <button
                  class="accordion-button fw-bold py-0 ps-3 ps-xl-4 pe-3"
                  type="button"
                  data-bs-toggle="collapse"
                        ...
                        <div class="col-md-12">
                          ...
                          <div id="f">
                            <Field
                              ...
                              type="password"
                              :rules="checkPwdRule"
                              class="form-control form_password action-pwd"
                              placeholder="請輸入密碼"
                              :class="{
                      ...
                      <div class="row verification">
                        <div class="col-md-12">
                          ...
                          <div class="input-group">
                            <Field
                              type="text"
                              class="form-control z-index-10 action-verify"
                  ...
                  <div class="member_discount">
                    <div class="ratio ratio-4x3">
                      <a href="https://www.yesgogogo.com/activity/2023_memberbonus/tenpercent">
                        <img
                          :src="`${eventbonus.link}?${getRandomString(8)}`"
                          alt="10%回饋"
                          class="img-fluid"
                        />
                      </a>
...
export default {
  ...
  methods: {
      ...
      this.axios.post(url, this.login).then(res => {
        ...
        this.$swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            } else if (this.$route.query.cardEvent) {
    ...
    toCheckoutCartList () {
      ...
      // vuex refreshCartPath的元素有值的話，就要導到購物車，是否要去購物車第0頁，這個動作是點擊首頁的購物車icon時候的判斷
    ...
    closeModal () {
      ...
      // ?要有token的頁面如果沒有token的話，就要導回到首頁(上方的條件是需要token的頁面)
        if (!AccessToken && !RefreshToken) {
          this.$router.push('/')
        }
      }

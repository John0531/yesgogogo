...
export default {
  ...
  methods: {
    ...
    getActiveTheme () {
      ...
      // 再判斷要打開哪個位置跟樣式，再用js一個個找，找到最接近的那一層放入show, 因為再選單要展開，所以再把coolapsed移除

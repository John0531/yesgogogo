<template>
    ...
    <div class="d-flex flex-column align-items-center justify-content-center" style="background-color:#fce28d;">

        <img class="img-fluid d-none d-lg-block" src="https://yesgoimages.s3.ap-northeast-1.amazonaws.com/yesgoevent/previewLoveDonation/preview_KV_PC.jpg" alt="">
